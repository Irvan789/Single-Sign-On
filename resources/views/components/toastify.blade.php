...
>
  ...
  >
    <div
      ...
      class="rounded-xs wrap-anywhere shadow-sm/10 pointer-events-auto relative ml-auto inline-flex w-full max-w-xs items-center gap-1.5 bg-[#ffffff73] px-2.5 py-2 shadow-[#5e6e75]"
      :class="{
